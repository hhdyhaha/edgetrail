/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: aa99ee8278cf006bbaf722463e9cb299)
// Runtime types generated with workerd@1.20260603.1 2026-06-05 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	ANALYTICS: AnalyticsEngineDataset;
	EVENT_QUEUE: Queue;
	DASHBOARD_ORIGIN: "https://your-edgetrail-web.example.com" | "http://localhost:3000";
	HASH_SECRET: string;
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		ANALYTICS: AnalyticsEngineDataset;
		EVENT_QUEUE: Queue;
		DASHBOARD_ORIGIN: "https://your-edgetrail-web.example.com";
		HASH_SECRET: string;
		PRESENCE_ROOMS: DurableObjectNamespace<import("./src/index").PresenceRoom>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DASHBOARD_ORIGIN" | "HASH_SECRET">> {}
}
